...
async def predict(file:UploadFile):
  ...
  return {"prediction":int(pred)}                 #return the predicted class index as a JSON response (convert from numpy int to regular Python int for better compatibility with JSON)